namespace LaserGRBL.RasterConverter
{
	partial class RasterToLaserForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.CbWhatModulate = new LaserGRBL.UserControls.EnumComboBox();
			...
			this.TLP.Controls.Add(this.CbWhatModulate, 1, 2);
			...
			this.TLP.Controls.Add(this.LblModulate, 0, 2);
			this.TLP.Name = "TLP";
			// 
			// UDQuality
			// 
			...
			// LblModulate
			// 
			resources.ApplyResources(this.LblModulate, "LblModulate");
			...
			// CbWhatModulate
			// 
			resources.ApplyResources(this.CbWhatModulate, "CbWhatModulate");
			this.TLP.SetColumnSpan(this.CbWhatModulate, 3);
			this.CbWhatModulate.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.CbWhatModulate.FormattingEnabled = true;
			this.CbWhatModulate.Name = "CbWhatModulate";
			this.CbWhatModulate.SelectedItem = null;
			this.TT.SetToolTip(this.CbWhatModulate, resources.GetString("CbWhatModulate.ToolTip"));
			this.CbWhatModulate.SelectedIndexChanged += new System.EventHandler(this.CbWhatModulate_SelectedIndexChanged);
			// 
			// RasterToLaserForm
			// 
		...
		private UserControls.EnumComboBox CbWhatModulate;
